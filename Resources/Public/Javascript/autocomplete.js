 ...
 *  (c) 2013 Tomas Kirda, Robin Rossow
 *
...
/*			// Listen for click event on suggestions list:
		...
		suggest: function () {
			...
			$('.tx-indexedsearch-searchbox-sword-trigger').click(function(e){
				e.preventDefault();
				$(".search-form").submit();
			});
		...
		onSelect: function (index) {
			var suggestion = this.suggestions[index].value;
			window.location = $(suggestion).attr("href");
/*			var that = this,
